        ...
        <div id="card" class="col-5 d-none">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Nilai penerimaan konsumen terhadap rasa durian dengan lama penyimpanan <span id="store"></span> bulan diprediksi memiliki nilai <span id="percentage"></span>. Batas nilai kesukaan terhadap rasa ditetapkan sebesar 77,48%.
                    </p>
                </div>
            </div>
        </div>
...
@section('scriptsPenurunanMutu')
    <script>
        ...
        document.getElementById("search").addEventListener("click", function() {
            ...
            const labels = [10,12,24];
            const data = [74.66666667,76,78];
